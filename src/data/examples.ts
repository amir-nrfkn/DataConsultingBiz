...
export const examples: EngagementExample[] = [
  {
    title: 'From weekly spreadsheet chaos to a trusted operations AI analyst',
    profile:
    ...
    problem:
      'Operations, finance, and leadership all had different numbers. The weekly production report took nearly a full day to prepare. The business wanted visibility into production output, scrap rates, late orders, raw material usage, and customer order status.',
    implementation:
      'Connected ERP, production spreadsheets, QA logs, and purchasing data into one central data layer. Cleaned and standardized product, order, and production records. Added data quality checks for missing fields, duplicates, and mismatched order IDs. Deployed an AI-powered analyst in Microsoft Teams. Added a simple form for supervisors to capture downtime reasons in structured format.',
    outcome:
      'Reporting shifted from manual spreadsheet assembly to a mostly automated workflow. Leadership got one trusted set of numbers. Managers could ask operational questions directly in Teams.',
  ...
  },
  {
    ...
    implementation:
      'Connected Shopify, HubSpot, ad data, and finance data into one central repository. Standardized customer, order, campaign, and revenue data. Added validation around duplicate customers, refunds, attribution gaps, and missing campaign tags. Deployed an AI-powered analyst into Slack. Added a lightweight internal form for campaign notes and promotions.',
    outcome:
      'The company moved from fragmented channel reporting to one trusted commercial dataset. Leadership got faster answers on revenue, marketing efficiency, and product performance. Commercial teams could query the AI analyst inside Slack instead of relying on spreadsheet analysis.',
  ...
  },
  {
    ...
    implementation:
      'Connected CRM, ERP, service logs, and spreadsheet field updates into one trusted data layer. Standardized customer IDs, service references, invoice statuses, and territory mappings. Added checks for broken cross-system links, stale job records, and missing updates. Deployed an AI-powered analyst into WhatsApp. Built a simple mobile-friendly form for field staff to submit structured service updates.',
    outcome:
      'The business gained a shared operational view across service, sales, and fulfillment. Managers stopped chasing updates across tools. The company created a practical data foundation for more reliable reporting and future automation.',
